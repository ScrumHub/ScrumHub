...
namespace ScrumHubBackend.CQRS.Tasks
{
    ...
    /// </summary>
    public class GetTasksForPBIQueryHandler : IRequestHandler<GetTasksForPBIQuery, PaginatedList<CommunicationModel.Task>>
    {
        ...
        /// <inheritdoc/>
        public Task<PaginatedList<CommunicationModel.Task>> Handle(GetTasksForPBIQuery request, CancellationToken cancellationToken)
        {
