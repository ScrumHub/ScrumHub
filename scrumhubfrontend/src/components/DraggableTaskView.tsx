...
export default function TaskView() {
  ...
  return (<>
          ...
          {isAddTaskModalVisible && !loading &&<CustomAddTaskPopup data={{ name: "" } as IFilters} visible={isAddTaskModalVisible}
            ...
            {isAssignTaskModalVisible && pbiPage && !loading &&<CustomAssignTaskPopup error={error.erorMessage} pbiData={namedPBIS as ICheckedAssignPBI[]} visible={isAssignTaskModalVisible}
